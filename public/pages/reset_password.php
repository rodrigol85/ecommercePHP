...
if(isset($_GET['token'])) {
    ...
    if(empty($userFound)){
        ...
        //header("Location: http://localhost/ecommerce/public/?page=homework");
        header("Location: ". ROOT_URL . "public/?page=homework");
        exit;
    }else{
     ...
     <form action="http://localhost/ecommerce/public/pages/update_password.php" method="POST" class="row g-3">
            <div class="mb-3">
