...
<body>
  ...
  <form action="../public/admin/pages/control-pages/controllo-categoria.php" method="POST">
      ...
      <tbody>
        <?php foreach ($categories as $category) : ?>
          <tr>
            ...
            <form action="http://localhost/ecommerce/public/admin/pages/control-pages/control_delete_categoria.php" method="post">
              <input type="hidden" name="id" value="<?php echo $category->getId(); ?>">
